 ...
 * was produced by buildExportPayload(). Validate every payload dependency at the
 * boundary to prevent a successful-looking export that drops runtime content.
 */
export interface ExportPayloadDependencyOptions {
  /**
...
export function assertExportPayloadDependencies(
  payload: ExportPayload,
  options: ExportPayloadDependencyOptions = {},
): void {
