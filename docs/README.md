...
| 当前软件路线与 Editor 1.0 收尾 | [COURSEWARE_DEVELOPMENT_PLAN.md](../COURSEWARE_DEVELOPMENT_PLAN.md)（12.2：车道 C 合同 + 车道 P 教师可见缺陷） |
| 可并行执行任务（T0–T6 与 P1–P7；全量只在最后） | [docs/tasks/editor-1.0/00_INDEX.md](tasks/editor-1.0/00_INDEX.md) |
