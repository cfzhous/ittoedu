...
> 状态：**不可领取**，直到下方清单全是「已合入」  
> 工人先读：[02_WORKER.md](02_WORKER.md)  
> 并行：否  
> **本包唯一允许全量验证的任务**

必须已经合入：T0、T1-E、T2、T3、T4、T5、P1、P2、P3、P4、P5-CSS、P5-persist、P6、P7、P8。  
T1-A/B/C/D 若仍暂缓：本任务扫描到 `legacy-runtime-v2` 时记入合同白名单（测试夹具），**不要在 T6 偷偷删判别器**。
