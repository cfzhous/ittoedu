...
| ID | 文档 | 主要产出 | 状态 |
|---|---|---|---|
| T01 | [`02_BASELINE_AND_DONOR_AUDIT.md`](02_BASELINE_AND_DONOR_AUDIT.md) | 安全恢复基线、V8/V9 缺口与 Git 供体矩阵 | DONE |
| T02 | [`03_ACTION_ROUTING_AND_SELECTION.md`](03_ACTION_ROUTING_AND_SELECTION.md) | 统一 selection snapshot、动作可用性与入口路由合同 | DONE |
| T03 | [`04_COURSE_STRUCTURE_AND_LAYOUT_POLICY.md`](04_COURSE_STRUCTURE_AND_LAYOUT_POLICY.md) | 三类空白创建、Pure/Mixed 推导、课程树模型 | DONE |
| T04 | [`05_CONTEXT_MENU_AND_LAYER_UI.md`](05_CONTEXT_MENU_AND_LAYER_UI.md) | 可访问右键菜单与紧凑有效图层 UI 原语 | DONE |
| T05 | [`06_SLIDE_V8_PARITY.md`](06_SLIDE_V8_PARITY.md) | Slide 选择/变换/文字/状态/剪贴板无降级 | DONE |
| T06 | [`07_GLOBAL_CONTROLLER_AUDIO_AND_LAYERS.md`](07_GLOBAL_CONTROLLER_AUDIO_AND_LAYERS.md) | 可见全局层、控制器、声音、共享层与图层管理 | DONE |
| T07 | [`08_FLOW_AUTHORING_AND_RUNTIME_TOC.md`](08_FLOW_AUTHORING_AND_RUNTIME_TOC.md) | Flow 页面—标题层级、就地编辑、运行态目录 | DONE |
| T08 | [`09_SPATIAL_AUTHORING.md`](09_SPATIAL_AUTHORING.md) | 无限画布、世界元素、镜头/路径/关系与 Player host | DONE |
| T09 | [`10_PLAYER_PUBLISH_AND_EXPORT.md`](10_PLAYER_PUBLISH_AND_EXPORT.md) | 跨 surface Player、控制器运行态、发布与导出一致性 | DONE |
| T09A | [`10A_ADVANCED_AUTHORING_REACHABILITY.md`](10A_ADVANCED_AUTHORING_REACHABILITY.md) | 互动/自动化、Runtime/Component、设计令牌和开发入口无降级 | DONE |
| T09B | [`10B_PROJECT_LIFECYCLE_AND_COMPATIBILITY.md`](10B_PROJECT_LIFECYCLE_AND_COMPATIBILITY.md) | 新建/打开/保存/另存/恢复、资源 sidecar 与 V8 显式导入 | DONE |
| T10 | [`11_CENTRAL_INTEGRATION_AND_MIXED.md`](11_CENTRAL_INTEGRATION_AND_MIXED.md) | 热点文件接线、Mixed 切换、统一快捷键与试运行 | DONE（integration candidate） |
| T11 | [`12_EXPERIENCE_CHECKLIST_AND_FACT_SYNC.md`](12_EXPERIENCE_CHECKLIST_AND_FACT_SYNC.md) | 最终人工检查清单、事实文档与能力卡同步 | DONE |
| T12 | [`13_FINAL_FULL_GATE.md`](13_FINAL_FULL_GATE.md) | 唯一全量自动化与真实体验 Gate | DONE（engineering candidate） |
