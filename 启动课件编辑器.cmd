...
if not exist "node_modules\electron\dist\electron.exe" (
  echo [Courseware Editor] Installing locked dependencies for first launch...
  call npm.cmd ci
  if errorlevel 1 goto failed
)

echo [Courseware Editor] Building and launching...
...
:missing_node
echo [Courseware Editor] Node.js and npm were not found.
echo Install Node.js LTS, then double-click this launcher again.
goto failed_pause

:invalid_root
echo [Courseware Editor] Keep this launcher in the project root.
goto failed_pause

:failed
echo [Courseware Editor] Build or launch failed. Review the error above.
